...
function emailit_settings_page() {
    ...
    ?>
                        ...
                        jQuery('#filter-form-input-text').keyup(function (event) {
                            ...
                            var nativeServices = ["Facebook", "Facebook_Like", "Facebook_Like_and_Share", "Facebook_Send", "Messenger","Twitter", "Google_Plus", "LinkedIn", "Pinterest", "VKontakte", "Odnoklassniki"];
                            if (value === "native") {
                ...
                <div id="tabs-advanced">
                    ...
                    <ul class="fields">                            
                        ...
                        <li>
                            ...
                            <label><?php _e('Insert your Ad Unit (or Promo) location', 'e-mailit') ?> (<a href="https://www.e-mailit.com/sample/ad-unit.html" target="_blank" download>Download/Save &amp; edit the sample file</a>)</label>
